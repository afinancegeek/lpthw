...
class Death(Scene):
	...
	quips = [
		...
		"You mom wouls be proud...if she were smarter.",
		"such a luser.",
...
class CentralCorridor(Scene):
 	...
 	def enter(self):
 		...
 		print "mission is to get the neurtron destruct bomb from the Weapons Armory,"
 		print "put it in the bridge, and blow the ship up after getting into an "
 		print "escape pod."
 		print "\n"
 		print "You're running down the central corridor to the Weapons Armory when"
 		print "a Gothon jumps out, red scaly skin, dark grimy teeth, and evil costume"
...
class LaserWeaponAromry(Scene):
	...
	def enter(self):
		...
		if guess == code:
			print "The constainer clicks open and the seal breaks, letting gas out."
			print "You grab the neutron bomb and run as fast as you can to the"
			print "bridge where you must place it in the right spot."
			return 'the_bridge'
		else:
			print "The lock buzzes one last time and the you hear a sickening"
			print "melting sound as the mechanism is fused togther."
			print "You decide to sit there, adn finally the Gothons blow up the"
...
class TheBridge(Scene):
	...
	def enter(self):
		...
		print "clown costume than the last. They haven't pulled theur"
		...
		if action == "throw the bomb":
			...
			print "You jump back through the door, punch the clsoe button"
...
class EscapePod(Scene):
	...
	def enter(self):
		...
		if int(guess) != good_pod:
			...
			print "The pod escapes put into the void of space, then"
			print "implodes as the hull rotures, crushing your body"
			print "into jam jelly."
			return 'death'
		else:
			print "You jump into pod %s and hit the eject button." % guess
			print "The pod easily slide out into space heading to"
			print "the planet below. As it flies tp the planet, you look"
			print "back and see you ship implode the explode like a"
